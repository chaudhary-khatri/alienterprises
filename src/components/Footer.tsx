    ...
    <footer className="bg-teal-700 text-white py-12">
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <Link
                href="https://www.facebook.com/profile.php?id=100077459363321"
                className="text-white hover:text-yellow-500 transition-colors"
                aria-label="Facebook"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/in/ali-enterprises-manufacturer-of-clay-bricks-making-machine-835276230/"
                className="text-white hover:text-yellow-500 transition-colors"
                aria-label="LinkedIn"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="https://x.com/ALIENTE74076863"
                className="text-white hover:text-yellow-500 transition-colors"
                aria-label="Twitter"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-teal-600 pt-6 text-center">
          <p className="text-sm text-gray-200">
            &copy; 2025 Ali Enterprises. All rights reserved.
          </p>
